...
export type AddProductsMutation = {
  __typename?: "Mutation";
...
export type ToggleProductIsAvailableMutation = {
  __typename?: "Mutation";
  toggleProductIsAvailable: boolean;
};
...
export type AddProductOptionsMutation = {
  __typename?: "Mutation";
  addProductOptions: boolean;
};
...
export type RemoveProductOptionsMutation = {
  __typename?: "Mutation";
  removeProductOptions: boolean;
};
...
export type UpdateProductOptionsMutation = {
  __typename?: "Mutation";
  updateProductOptions: boolean;
};
...
export type ToggleStoreIsAvailableMutation = {
  __typename?: "Mutation";
  toggleStoreIsAvailable: boolean;
};
...
export const TodayOrdersDocument = `
  ...
  todayOrders(offset: $offset, limit: $limit) {
    ...
    `;
export const useTodayOrdersQuery = <TData = TodayOrdersQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<TodayOrdersQuery, TError, TData>(
    ...
    fetcher<TodayOrdersQuery, TodayOrdersQueryVariables>(
      client,
      TodayOrdersDocument,
      variables,
      headers,
...
export const AddOrderDocument = `
  ...
  addOrder(order: $order)
    ...
    `;
export const useAddOrderMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  ...
  useMutation<AddOrderMutation, TError, AddOrderMutationVariables, TContext>(
    ...
    (variables?: AddOrderMutationVariables) =>
      fetcher<AddOrderMutation, AddOrderMutationVariables>(
        client,
        AddOrderDocument,
        variables,
        headers,
...
>(
  ...
  >(
    ...
    (variables?: UpdateOrderStatusMutationVariables) =>
      fetcher<UpdateOrderStatusMutation, UpdateOrderStatusMutationVariables>(
        client,
...
export const AddProductsDocument = `
  ...
  addProducts(products: $products)
    ...
    `;
export const useAddProductsMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  options?: UseMutationOptions<
    AddProductsMutation,
    TError,
  ...
  >(
    ["addProducts"],
    (variables?: AddProductsMutationVariables) =>
      fetcher<AddProductsMutation, AddProductsMutationVariables>(
        client,
        AddProductsDocument,
        variables,
        headers,
...
export const useRemoveProductsMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ...
    (variables?: RemoveProductsMutationVariables) =>
      fetcher<RemoveProductsMutation, RemoveProductsMutationVariables>(
        client,
...
>(
  client: GraphQLClient,
  options?: UseMutationOptions<
    ToggleProductIsAvailableMutation,
    TError,
    ToggleProductIsAvailableMutationVariables,
    TContext
  >,
  headers?: RequestInit["headers"],
) =>
  ...
  >(
    ...
    (variables?: ToggleProductIsAvailableMutationVariables) =>
      fetcher<
        ToggleProductIsAvailableMutation,
        ToggleProductIsAvailableMutationVariables
      >(client, ToggleProductIsAvailableDocument, variables, headers)(),
    options,
  );
...
>(
  ...
  options?: UseMutationOptions<
    ...
    TError,
    AddProductOptionsMutationVariables,
    TContext
  >,
  headers?: RequestInit["headers"],
) =>
  ...
  >(
    ["addProductOptions"],
    (variables?: AddProductOptionsMutationVariables) =>
      fetcher<AddProductOptionsMutation, AddProductOptionsMutationVariables>(
        client,
        AddProductOptionsDocument,
        variables,
        headers,
      )(),
    options,
...
>(
  client: GraphQLClient,
  options?: UseMutationOptions<
    RemoveProductOptionsMutation,
    TError,
    RemoveProductOptionsMutationVariables,
    TContext
  >,
  headers?: RequestInit["headers"],
) =>
  ...
  >(
    ...
    (variables?: RemoveProductOptionsMutationVariables) =>
      fetcher<
        RemoveProductOptionsMutation,
        RemoveProductOptionsMutationVariables
      >(client, RemoveProductOptionsDocument, variables, headers)(),
    options,
  );
...
>(
  ...
  >(
    ...
    (variables?: UpdateProductOptionsMutationVariables) =>
      fetcher<
        UpdateProductOptionsMutation,
        UpdateProductOptionsMutationVariables
      >(client, UpdateProductOptionsDocument, variables, headers)(),
    options,
  );
...
export const useStoresQuery = <TData = StoresQuery, TError = unknown>(
  ...
  useQuery<StoresQuery, TError, TData>(
    ...
    fetcher<StoresQuery, StoresQueryVariables>(
      client,
      StoresDocument,
      variables,
      headers,
...
export const MyStoresDocument = `
  ...
  myStores {
    ...
    `;
export const useMyStoresQuery = <TData = MyStoresQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<MyStoresQuery, TError, TData>(
    ...
    fetcher<MyStoresQuery, MyStoresQueryVariables>(
      client,
      MyStoresDocument,
      variables,
      headers,
...
>(
  client: GraphQLClient,
  options?: UseMutationOptions<
    ToggleStoreIsAvailableMutation,
    TError,
    ToggleStoreIsAvailableMutationVariables,
    TContext
  >,
  headers?: RequestInit["headers"],
) =>
  ...
  >(
    ...
    (variables?: ToggleStoreIsAvailableMutationVariables) =>
      fetcher<
        ToggleStoreIsAvailableMutation,
        ToggleStoreIsAvailableMutationVariables
      >(client, ToggleStoreIsAvailableDocument, variables, headers)(),
    options,
  );
export const AddStoreDocument = `
  ...
  addStore(store: {name: $name, code: $code, address: $address, phone: $phone})
    ...
    `;
export const useAddStoreMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  options?: UseMutationOptions<
    AddStoreMutation,
    TError,
  ...
  useMutation<AddStoreMutation, TError, AddStoreMutationVariables, TContext>(
    ["addStore"],
    (variables?: AddStoreMutationVariables) =>
      fetcher<AddStoreMutation, AddStoreMutationVariables>(
        client,
        AddStoreDocument,
        variables,
        headers,
...
export const RemoveStoreDocument = `
  ...
  removeStore(id: $id)
    ...
    `;
export const useRemoveStoreMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  options?: UseMutationOptions<
    RemoveStoreMutation,
    TError,
    RemoveStoreMutationVariables,
    TContext
  >,
  headers?: RequestInit["headers"],
) =>
  ...
  >(
    ["removeStore"],
    (variables?: RemoveStoreMutationVariables) =>
      fetcher<RemoveStoreMutation, RemoveStoreMutationVariables>(
        client,
        RemoveStoreDocument,
        variables,
        headers,
